    ...
    <section id="main">
        ...
        <div class="section3">
            <div class="section3-container-left">
                ...
                <section class="section3-container">
                    ...
                    <div class="section3-row">
                        <div class="section3-writing">
                            ...
                            <p>Polar bears are just one small part of our environment that need protecting. From saving our honeybees to protecting the ocean, many areas of our planet need relief from the effects of climate change. To make an impact no matter where you live.<br> <br>
                                <ul>
                ...
                <h2 id="sign_in_username">You are signed in as: <?php echo $_SESSION['login_user']; ?></h2>
                <button id="login_button" onclick="window.location.href='../login/login.php';">
                    Log in
                </button>
                <script>
                ...
                <form method="post" id="feedbackform" form="feedbackform">
                    ...
                    <textarea name="comment" id="FeedbackText" form="feedbackform" class="text" rows="5" cols="50">
                        Enter comment here...
                    </textarea><br><br>
                ...
                function get()
                {
                    ...
                    if ($result) {
                        ...
                        $wholePage = $wholePage . "<h1 style=\"text-align: center; font-size: 4vw; display: inline\">We'd love your feedback!</h1>";
